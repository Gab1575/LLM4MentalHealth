...
static const _RobotCommand_type_support_symbol_names_t _RobotCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flower_msgs, msg, RobotCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flower_msgs, msg, RobotCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flower_msgs, msg, RobotCommand)() {
  return &::flower_msgs::msg::rosidl_typesupport_c::RobotCommand_message_type_support_handle;
}
